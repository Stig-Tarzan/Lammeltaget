...
$('#add_trail').css('bottom', '15%');
  ...
  echo $googlemaps_api;
  echo "<label id='vote_trail_name' value='$trail_name'><p>$trail_name</p></label>";
  echo "<label id='vote_trail_creator_name' value='$trail_creator'><p>Skapad av: $trail_creator</p></label>"; 
